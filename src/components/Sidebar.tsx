...
import { formatSubCategory } from '../api/client';
...
export default function Sidebar({ isOpen = false, onClose }: SidebarProps) {
  ...
  return createPortal(
      <>
        ...
        <aside
            className={`fixed left-0 top-0 z-[9999] flex h-screen w-[300px] max-w-[calc(100vw-2rem)] flex-col border-r border-orange-300 bg-[#f27128] px-5 py-6 text-white shadow-[18px_0_45px_rgba(15,23,42,0.18)] transition-transform duration-300 ${
        ...
        >
          ...
          <div className="mt-8 flex-1 overflow-y-auto pr-1">
            ...
            <div className="mt-8 border-t border-white/20 pt-6">
              <p className="px-4 text-xs font-black uppercase tracking-[0.22em] text-orange-50">
                Subcategories
              </p>
          ...
          <div className="mt-6 rounded-[1.5rem] border border-white/20 bg-white/15 p-4">
